      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4 max-w-md">
              Join me on my journey as a work-from-home full-stack developer, hands-on dad, and husband. 
              Watch coding tutorials, dev vlogs, and learn about the developer lifestyle.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/videos" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200">
                  Videos
                </Link>
              </li>
              <li>
                <Link to="/playlists" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200">
                  Playlists
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/subscribe" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200">
                  Subscribe
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800">
          <p className="text-center text-gray-500 dark:text-gray-400 text-sm">
            &copy; {currentYear} DevLife Academy. All rights reserved. Built with ❤️ for the dev community.
          </p>
        </div>
      </div>
    </footer>
